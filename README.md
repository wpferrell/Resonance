...
```
ââ Resonance Update Available ââââââââââââââââââââââââââ
â  New version: 2.0.1  (you have 2.0.0)                â
â  pip install --upgrade resonance-layer               â
...
If you are in crisis, Resonance will flag it - `crisis_detected` is set to True in the EmotionResult - and any application built on Resonance is required to surface appropriate support immediately.
